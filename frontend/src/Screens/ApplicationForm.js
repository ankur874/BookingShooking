...
const Index = () => {
    ...
    return (
        <form id="login" onSubmit={handleSubmit}>
            <div className="dark:bg-gray-800 pb-3" style={{ backgroundImage: `url("https://www.industrialempathy.com/img/remote/ZiClJf-640w.avif")`}}>
                    ...
                    <div className="container mx-auto bg-white dark:bg-gray-800 rounded px-4">
                        <div className="xl:w-full border-b border-gray-300 dark:border-gray-700 py-5 dark:bg-gray-800">
                            <div className="flex w-11/12 mx-auto xl:w-full xl:mx-0 items-center">
                                <p className="text-lg text-gray-800 dark:text-gray-100 font-bold">Application Form</p>
                            </div>
                        </div>
